...
public class KeyManageActivity extends Activity
{
    ...
    //onCreate function is used to initialize the whole application
    ...
    /*
    *layoutSwitch function is used to switch layouts among Main Page, Symmetric Sub
    *application, Asymmetric Sub application, and Diffie-Hellman Sub application.
    */
    ...
    /*
    *checkBeforeEncrypt function is used to make sure every parameter for encryption has
    *been ready. (Asymmetric method)
    */
    ...
    /*
    *beginEncryptAndDecrypt function is used to get Text and generate encrypted result
    *and decrypted result. (Asymmetric method)
    */
    ...
    */
    ...
    /*
    *beginSymEncryptAndDecrypt function is used to get Text and generate encrypted result
    *and decrypted result. (Symmetric method)
    */
    ...
    /*
    *checkKeyExchangeParam function is used to make sure all parameters ready for
    *Diffie-Hellman method.
    */
    public boolean checkKeyExchangeParam()
    {
        if (pET.getText().toString().equals("") || gET.getText().toString().equals("") || gET.getText().toString().equals("") || gET.getText().toString().equals(""))
        {
    ...
    public void updateStatus()
    {
        ...
        switch(step)
        {
            ...
            case 1:
            {
                ...
                jackTV.setText("Current Hold: b = " + b.toString()
                        + ", p = " + p.toString()
                        + ", g = " + g.toString() + ".");
                step++;
                break;
            ...
            case 2:
            {
                joshTV.setText( "Current Hold: p = " + p.toString()
                        + ", g = " + g.toString()
                        + ", a = " + a.toString()
                        + ", A = " + A.toString()
                        + ".");
                jackTV.setText("Caculation: B = g^b mod p. \n" +
                        "Current Hold: p = " + p.toString()
                        + ", g = " +  g.toString()
                        + ", a = " + a.toString()
                        + ", A = " + A.toString()
                        + ", B = " + B.toString()
