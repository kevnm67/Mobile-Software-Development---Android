...
public class FriendsCustomAdapter extends ArrayAdapter<Friend> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final String birthday = friend.getBirthday();
       
        ((TextView) view.findViewById(R.id.friend_name)).setText(name);
        ((TextView) view.findViewById(R.id.friend_birthday)).setText(birthday);
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(FriendsContract.FriendsColumns.FRIENDS_BIRTHDAY, birthday);
