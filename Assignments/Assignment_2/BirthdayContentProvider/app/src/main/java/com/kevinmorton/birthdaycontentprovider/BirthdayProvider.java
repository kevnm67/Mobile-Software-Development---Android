...
//    }
    static final String PROVIDER_NAME = "com.kevinmorton.provider.BirthdayProvider";
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "friends/#", FRIEND_ID);
    }

    private SQLiteDatabase db;
    static final String DATABASE_NAME = "Birthday";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case FRIEND_ID:
                ...
                count = db.delete(FRIENDS_TABLE_NAME, _ID + " = " + id +
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case FRIENDS:
                ...
                break;
            case FRIEND_ID:
                count = db.update(FRIENDS_TABLE_NAME, values, _ID +
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case FRIENDS:
                return "vnd.android.cursor.dir/vnd.kevinmorton.friends";
            case FRIEND_ID:
                return "vnd.android.cursor.item/vnd.kevinmorton.friends";
            default:
